 ...
 */
public class PacketChannelInfoAutojoin extends Packet {
	
	public String channel;
	public String description;
	public int integer;
	
	public PacketChannelInfoAutojoin() {}
	
	public PacketChannelInfoAutojoin(String channel, String description, int integer) {
